(global => {
    ...
    toolbox.router.get('/beer/css/(.*)', global.toolbox.networkFirst, {
      cache: {
    ...
    toolbox.router.get('/beer/images/(.*)', global.toolbox.networkFirst, {
      cache: {
        name: 'beer-images'
      },
      networkTimeoutSeconds: 4
    ...
    toolbox.router.get('/beer/js/(.*)', global.toolbox.networkFirst, {
      cache: {
    ...
    toolbox.router.get('/beer/data/(.*)', global.toolbox.networkFirst, {
      cache: {
        name: 'beer-data'
      },
      networkTimeoutSeconds: 4
