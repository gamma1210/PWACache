(global => {
    ...
    toolbox.router.get('/(.*)', global.toolbox.cacheOnly, {
      cache: {
        name: 'googleapis'
      },
    ...
    toolbox.router.get('/beer/css/(.*)', global.toolbox.cacheOnly, {
      cache: {
    ...
    toolbox.router.get('/beer/images/(.*)', global.toolbox.cacheOnly, {
      cache: {
        name: 'beer-images'
      },
      networkTimeoutSeconds: 4
    ...
    toolbox.router.get('/beer/js/(.*)', global.toolbox.cacheOnly, {
      cache: {
    ...
    toolbox.router.get('/beer/data/(.*)', global.toolbox.cacheOnly, {
      cache: {
        name: 'beer-data'
      },
      networkTimeoutSeconds: 4
