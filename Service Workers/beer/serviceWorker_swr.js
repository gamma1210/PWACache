(global => {
    ...
    toolbox.router.get('/beer/css/(.*)', global.toolbox.fastest, {
      cache: {
    ...
    toolbox.router.get('/beer/images/(.*)', global.toolbox.fastest, {
      cache: {
        name: 'beer-images'
      },
      networkTimeoutSeconds: 4
    ...
    toolbox.router.get('/beer/js/(.*)', global.toolbox.fastest, {
      cache: {
    ...
    toolbox.router.get('/beer/data/(.*)', global.toolbox.fastest, {
      cache: {
        name: 'beer-data'
      },
      networkTimeoutSeconds: 4
